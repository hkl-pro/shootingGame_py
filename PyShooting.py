...
def initGame():
    ...
    background = pygame.image.load('C:\PyShooting/background.png') # 배경이지미 출력
    fighter = pygame.image.load('C:\PyShooting/fighter.png') # 전투기 이미지 출력
    missile = pygame.image.load('C:\PyShooting/missile.png')
